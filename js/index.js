...
for (let e = hacker2.length - 1; e > -1; e--) {
    result2 += hacker2[e];
}
...
// Bonus 1 -- Check number of letters. Check number of 'et' in the phrase. 
...
const isPalindrome=(inStr) => {
  ...
  for (let r=0; r<inStr.length; r+=1){
    if (inStr[r] !== inStr[inStr.length-1-r]) {
      return false;
    }
  }
  return true;
